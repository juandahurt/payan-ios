//
//  PYFeedInnerCardCollectionViewCell.swift
//  Payan
//
...
class PYFeedInnerCardCollectionViewCell: UICollectionViewCell {
    ...
    static let reuseIdentifier = "PYFeedInnerCardCollectionViewCell"
